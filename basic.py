...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'Evanesco'):
      res.register_advancement()
      self.advance()
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'OwlPost', 'Skip', 'Evanesco', 'Scroll', 'Expecto', 'Repeat', 'Loop', 'Spell', int, float, identifier, '+', '-', '(', '[' or 'Not'"
      ))
  ...
  def expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'Scroll'):
      res.register_advancement()
      self.advance()
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'Scroll', 'Expecto', 'Repeat', 'Loop', 'Spell', int, float, identifier, '+', '-', '(', '[' or 'Not'"
      ))
  ...
  def comp_expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected int, float, identifier, '+', '-', '(', '[', 'Expecto', 'Repeat', 'Loop', 'Spell' or 'Not'"
      ))
  ...
  def atom(self):
    ...
    elif tok.matches(TT_KEYWORD, 'Expecto'):
    ...
    elif tok.matches(TT_KEYWORD, 'Spell'):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, float, identifier, '+', '-', '(', '[', Expecto', 'Repeat', 'Loop', 'Spell'"
    ))
  ...
  def if_expr(self):
    res = ParseResult()
    all_cases = res.register(self.if_expr_cases('Expecto'))
    if res.error: return res
    cases, else_case = all_cases
    return res.success(IfNode(cases, else_case))

  def if_expr_b(self):
    return self.if_expr_cases('Also')
    
  def if_expr_c(self):
    res = ParseResult()
    else_case = None

    if self.current_tok.matches(TT_KEYWORD, 'Patronum'):
      res.register_advancement()
      self.advance()
      ...
      if self.current_tok.type == TT_NEWLINE:
        ...
        if self.current_tok.matches(TT_KEYWORD, 'Finite'):
          res.register_advancement()
          self.advance()
        else:
          return res.failure(InvalidSyntaxError(
  ...
  def if_expr_b_or_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'Also'):
  ...
  def if_expr_cases(self, case_keyword):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 'Cast'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Expected 'Cast'"
      ))
  ...
  def for_expr(self):
    ...
    if self.current_tok.type == TT_NEWLINE:
      ...
      if not self.current_tok.matches(TT_KEYWORD, 'Finite'):
        return res.failure(InvalidSyntaxError(
          self.current_tok.pos_start, self.current_tok.pos_end,
          f"Expected 'Finite'"
        ))
  ...
  def func_def(self):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 'Spell'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Expected 'Spell'"
      ))
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_run(self, exec_ctx):
    ...
    _, error = run("Harry_Potter.hp", script)
...
global_symbol_table.set("Obliviate", Number.null)
global_symbol_table.set("Nox", Number.false)
...
global_symbol_table.set("Pack", BuiltInFunction.append)
global_symbol_table.set("Unpack", BuiltInFunction.pop)
